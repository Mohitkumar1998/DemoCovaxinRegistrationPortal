...
class ApplicantServiceImplTest {
    ...
    static void setVariables() {
        ...
        testApplicant = new Applicant("John", Date.from(OffsetDateTime.parse("2021-06-20T13:28:06.419Z").toInstant()), testApplicantAadharDetails);
    }
    ...
    void removeApplicantException() {
        Mockito.when(applicantRepo.existsById(Mockito.anyLong())).thenReturn(false);
        ResourceNotFoundException e = assertThrows(ResourceNotFoundException.class,
                () -> service.removeApplicant(Long.valueOf("1")));
